...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Role', fields ['user', 'project', 'role']
        db.delete_unique('agilito_role', ['user_id', 'project_id', 'role'])

        # Deleting model 'Role'
        db.delete_table('agilito_role')

        # Adding model 'ProjectMember'
        db.create_table('agilito_projectmember', (
        ...
        db.send_create_signal('agilito', ['ProjectMember'])

        # Adding unique constraint on 'ProjectMember', fields ['user', 'project', 'role']
        db.create_unique('agilito_projectmember', ['user_id', 'project_id', 'role'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProjectMember', fields ['user', 'project', 'role']
        db.delete_unique('agilito_projectmember', ['user_id', 'project_id', 'role'])
        ...
        # Adding unique constraint on 'Role', fields ['user', 'project', 'role']
        db.create_unique('agilito_role', ['user_id', 'project_id', 'role'])

        # Deleting model 'ProjectMember'
        db.delete_table('agilito_projectmember')
