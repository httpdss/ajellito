...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Role', fields ['project', 'role', 'user']
        db.create_unique('agilito_role', ['project_id', 'role', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Role', fields ['project', 'role', 'user']
        db.delete_unique('agilito_role', ['project_id', 'role', 'user_id'])
    ...
    models = {
        ...
        'agilito.role': {
            'Meta': {'unique_together': "(('user', 'project', 'role'),)", 'object_name': 'Role'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['agilito.Project']"}),
